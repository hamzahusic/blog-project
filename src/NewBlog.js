...
const NewBlog = () => {
    ...
    return ( 
        <div className="p-[20px] flex flex-col gap-[150px]">
            ...
            <form className=" flex flex-col w-[400px] mx-auto p-[25px] bg-gray-300 gap-[10px] rounded-lg" onSubmit={addBlog}>
                ...
                <textarea required className="h-[150px]" value={body} onChange={(e) => setBody(e.target.value)}></textarea>
